...
RSpec.describe UsageMonitoring::BillableMetricLifetimeUsageUnitsAlert do
  subject { alert.find_value(current_usage) }

  let(:alert) { create(:billable_metric_lifetime_usage_units_alert, subscription_external_id: "test") }
