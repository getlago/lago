...
func TestBuildChargeKey(t *testing.T) {
	...
	expectedKey := "ch:org-123:plan-123:bm-123"
	key := cache.buildChargeKey(testModel.organizationID, testModel.planID, testModel.billableMetricID)
...
func TestGetCharge_Success(t *testing.T) {
	...
	result := cache.GetCharge("org-123", "plan-123", "bm-123")
...
func TestGetCharge_NotFound(t *testing.T) {
	...
	result := cache.GetCharge("org1", "plan1", "bm1")
